    ...
    if (listOpt === "both") {
        ...
        if (type === "movie") {
            ...
            for (let debridprovider of userConfiguration.debridservices) {
                movieDebridLinks = await getMovieCachedDebridLinks(keyuser,keyapp,idimdb,limitcount,videoquality, audiochannels,sortvalue, debridprovider, clientIp, audiolanguages,additionalParameters,orionCache)
            ...
            for (let debridprovider of userConfiguration.debridservices) {
                seriesDebridLinks = await getSeriesCachedDebridLinks(keyuser,keyapp,idimdb,limitcount,videoquality,audiochannels,sortvalue,numberseason,numberepisode,debridprovider,clientIp,audiolanguages,additionalParameters,orionCache)
