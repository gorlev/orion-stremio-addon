...
async function dataHandler(userConf, videoId, type, season, episode){
    ...
    "body": `keyuser=${keyuser}&keyapp=${keyapp}&mode=stream&action=retrieve&type=${type}&idimdb=${idimdb}&limitcount=${limitcount}&videoquality=${videoquality}&audiochannels=${audiochannels}&streamtype=torrent&sortvalue=${sortvalue}&numberseason=${numberseason}&numberepisode=${numberepisode}`,
    "method": "POST" 
    });
