...
async function getSeriesCachedDebridLinks(keyuser,keyapp,idimdb,limitcount,videoquality,audiochannels,sortvalue,numberseason,numberepisode,debrid,clientIp,audiolanguages,additionalParameters,orionCache,userAgent){
    ...
    let params = {
            ...
            deviceIP: clientIp,
            deviceAgent: encodeURIComponent(userAgent)
        }
